...
export function SignIn({ onLogin }: SignInProps) {
  ...
  const handleLogin = () => {
    ...
    setLoading(true);
    setTimeout(() => { setLoading(false); onLogin(matched.userID); }, 600);
  };
  ...
  return (
    ...
    >
      <div
        className="w-full flex items-center justify-between gap-8 px-12"
        style={{ maxWidth: 1100 }}
      >
        {/* ── Left: form ── */}
        <div style={{ flex: "0 0 420px", maxWidth: 420 }}>
          ...
          <div className="mb-10">
            ...
            >
              Electronics<br />Corp<br />
              <span style={{ color: "#3b82f6" }}>ISCS</span>
            </h1>
          </div>

          {/* Error */}
          {error && (
            <div className="mb-4 px-4 py-2 rounded-lg" style={{ background: "#ef444418", color: "#f87171", fontSize: 13 }}>
              {error}
            </div>
          )}
          ...
          {/* Username */}
          <div className="mb-4">
            <label style={{ display: "block", fontWeight: 600, fontSize: 13, color: "#cbd5e1", marginBottom: 8 }}>
              Username:
            </label>
            <input
              type="text"
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="#"
              style={{ color: "#3b82f6", fontWeight: 600, fontSize: 14, textDecoration: "underline" }}
